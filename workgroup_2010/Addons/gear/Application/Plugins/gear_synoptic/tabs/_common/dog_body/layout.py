...
## @package gear_Synoptic.dog_body.layout
...
def addLayout(layout, prop):
    ...
    # HTML Page ---------------------
    path = os.path.join(plu.getPluginPath("gear_Synoptic"), "tabs", "_common", "dog_body", "dog_body.htm")
    prop.Parameters("dog_body_path").Value = path
    item = layout.AddItem("dog_body_path", "", c.siControlSynoptic)
    item.SetAttribute(c.siUINoLabel, True)
