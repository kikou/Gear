...
## @package gear_Synoptic.horse_body.layout
...
def addLayout(layout, prop):
    ...
    # HTML Page ---------------------
    path = os.path.join(plu.getPluginPath("gear_Synoptic"), "tabs", "_common", "horse_body", "horse_body.htm")
    prop.Parameters("horse_body_path").Value = path
    item = layout.AddItem("horse_body_path", "", c.siControlSynoptic)
    item.SetAttribute(c.siUINoLabel, True)
