...
#
# @brief main gear module with core method for logging and reloading library
...
try:
    ...
    xsi_application = Dispatch("XSI.Application").Application
except:
    xsi_application = False
...
def logInfos():
    print "GEAR version : "+str(version)
    print "author : Jeremie Passerin"
...
def log(message, severity=sev_comment, infos=False):
    ...
    if xsi_application:
        xsi_application.LogMessage(message, severity)
    else:
