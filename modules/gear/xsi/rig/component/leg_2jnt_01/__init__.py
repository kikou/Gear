...
## @package gear.xsi.rig.component.leg_2jnt_01
...
# GLOBAL
##########################################################
from gear.xsi import XSIMath, c, xsi
...
class Component(MainComponent):
    ...
    def addLogic(self):
        ...
        self.anim_logic.addOnClicked(self.getName("ikfkSwitch"),
                              "prop = PPG.Inspected(0)\r\n" +
                              "switcher = logic.IKFKSwitcher(prop.Model, prop.Parent3DObject, '"+self.getName()+"', True, "+str(self.negate)+")\r\n" +
                              "switcher.switch()\r\n" +
                              "PPG.Refresh()\r\n")
    ...
    def addOperators(self):
        ...
        op = aop.sn_ikfk2bone_op(out, self.root, self.ik_ref, self.upv_ctl, self.fk0_ctl, self.fk1_ctl, self.fk_ref, self.length0, self.length1, self.negate)
