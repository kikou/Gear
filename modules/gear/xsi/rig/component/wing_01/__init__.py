...
## @package gear.xsi.rig.component.wing_01
...
class Component(MainComponent):
    ...
    def addParameters(self):
        ...
        # Membrane
        self.pRestDist = self.addSetupParam("rest_dist", c.siDouble, 0, 0, None, 0, 10)
        self.pStartPos = self.addSetupParam("start_pos", c.siDouble, self.settings["start_pos"], None, None, -2, 2)
        self.pEndPos = self.addSetupParam("end_pos", c.siDouble, self.settings["end_pos"], None, None, -2, 2)
    ...
    def addLayout(self):
        ...
        group.addItem(self.pRestDist.ScriptName, "Rest Distance")
    ...
    def addOperators(self):
        ...
        aop.poseCns(self.tws2_rot, self.eff_loc, True, False, True, False)
        par.addExpression(self.tws2_rot.Parameters("rotx"), self.ik_ctl.Parameters("rotx").FullName + " * (1 - "+self.pBlend.FullName+") + " + self.fk2_ctl.Parameters("rotx").FullName + " * " + self.pBlend.FullName)
    ...
    def setRelation(self):
        ...
        self.relatives["wrist"] = self.tws2_rot
