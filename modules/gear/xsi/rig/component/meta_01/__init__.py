...
class Component(MainComponent):
    ...
    def addOperators(self):
        ...
        for i, loc in enumerate(self.loc):
            ...
            cns = loc.Kinematics.AddConstraint("Position", self.start_ctl, True)
            cns = loc.Kinematics.AddConstraint("Position", self.end_ctl, True)
            cns.Parameters("blendweight").Value = u

            cns = loc.Kinematics.AddConstraint("Orientation", self.start_ctl, True)
            cns = loc.Kinematics.AddConstraint("Orientation", self.end_ctl, True)
            cns.Parameters("blendweight").Value = u
